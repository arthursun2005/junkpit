# Generated by Powerlevel10k configuration wizard on 2021-07-17 at 15:17 AEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=213
  # Custom icon.
  ...
  function my_git_formatter() {
    ...
    local      clean='%253F' # black foreground
    local   modified='%253F' # black foreground
    local  untracked='%253F' # black foreground
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=226
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=219
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=26
